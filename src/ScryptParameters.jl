#=
This file is adopted from Scrypt.jl (https://github.com/BioTurboNick/Scrypt.jl) with necessary modifications.

LICENSE: Apache License 2.0 (https://github.com/BioTurboNick/Scrypt.jl/blob/v0.2.1/LICENSE)
   ...
   Copyright 2020 Nicholas C. Bauer PhD
